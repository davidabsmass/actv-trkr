...
public static function defaults(){return array('api_key'=>defined('MM_BAKED_API_KEY')?MM_BAKED_API_KEY:'','endpoint_url'=>defined('MM_BAKED_ENDPOINT')?MM_BAKED_ENDPOINT:'${ENDPOINT_BASE}','enable_tracking'=>'1','enable_gravity'=>'1');}
