      ...
      <div style="margin-bottom:12px">
        <div style="display:flex;align-items:center;gap:12px">
          ...
          <div style="position:relative;flex:1;min-width:0;height:24px;border-radius:6px;background:rgba(228,230,237,0.45);overflow:hidden">
            ...
            <span style="position:relative;z-index:1;display:flex;align-items:center;padding:0 8px;font-size:12px;font-weight:500;color:#00264d;height:24px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${safe(item.label)}</span>
          </div>
