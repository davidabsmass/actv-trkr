...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 landing-page-fonts">
      ...
      <section className="px-6 landing-section-pad overflow-visible" style={{ paddingTop: '100px', paddingBottom: '80px', backgroundImage: `url(${platformBg})`, backgroundSize: 'cover', backgroundPosition: 'center top' }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative">
            ...
            <div className="relative flex items-end">
              ...
              <img
                src={spaceManBack}
                alt="Astronaut"
                className="absolute -bottom-[80px] right-[9%] h-[75%] w-auto object-contain pointer-events-none z-10"
              />
            </div>
