...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 landing-page-fonts">
      ...
      <section className="relative px-6 overflow-hidden visitor-behavior-section landing-section" style={{ paddingTop: '100px', paddingBottom: '65px', backgroundImage: `url(${visBehaviorBgd})`, backgroundSize: 'cover', backgroundPosition: 'right bottom' }}>
        <SparkleCanvas />
        ...
        <div className="max-w-7xl mx-auto" style={{ transform: 'translateY(-20px)' }}>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="relative lg:col-span-7 flex items-end justify-start min-h-0 lg:min-h-[460px]">
               ...
               <img src={visBehaviorSmall} alt="Rocket launch pad" className="absolute bottom-[-105px] right-[10px] lg:bottom-[-105px] lg:right-[2%] w-[130px] lg:w-[150px] h-auto z-20 rounded-xl prlx" style={{ transform: `translateY(${(scrollY - 2600) * -0.12}px)`, willChange: 'transform' }} />
            </div>
          ...
          <div className="text-center mb-6">
            ...
            <div className="flex items-center justify-center gap-3 mt-4">
              ...
              <button
                ...
                className={`relative w-11 h-6 rounded-full transition-colors ${isAnnual ? 'bg-primary' : 'bg-white/30'}`}
              >
                <span className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white transition-transform ${isAnnual ? 'translate-x-5' : ''}`} />
              </button>
              <span className={`text-sm font-medium ${isAnnual ? 'text-white' : 'text-white/50'}`} style={{ fontFamily: "'BR Omega', sans-serif" }}>Yearly <span className="text-primary text-xs font-semibold">Save $45</span></span>
            </div>
          </div>
