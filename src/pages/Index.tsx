        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="relative lg:col-span-7 flex items-end justify-start min-h-[460px]">
              ...
              <img src={satelliteChartTiny} alt="Total Submissions" className="absolute top-[40px] right-[2%] w-[150px] h-auto z-20 rounded-xl shadow-lg" style={{ transform: `translateY(${(scrollY - 1800) * -0.12}px)`, willChange: 'transform' }} />
              <img src={satelliteImg} alt="Satellite" className="absolute bottom-[50px] right-[2%] w-[180px] h-auto z-20 pointer-events-none" style={{ transform: `translateY(${(scrollY - 1800) * 0.05}px) rotate(-10deg)`, willChange: 'transform' }} />
            </div>
            <div className="lg:col-span-5">
