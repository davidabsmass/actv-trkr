...
const card = { backgroundColor: '#F3F4F6', borderRadius: '10px', padding: '16px 18px', margin: '12px 0 20px', textAlign: 'left' as const}
...
const buttonWrap = { textAlign: 'left' as const, margin: '20px 0 0' }
const button = { backgroundColor: '#6C5CE7', color: '#ffffff', fontSize: '15px', fontWeight: '600' as const, borderRadius: '12px', padding: '12px 28px', textDecoration: 'none', display: 'inline-block', textAlign: 'left' as const}
