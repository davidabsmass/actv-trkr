...
const Email = ({ name }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Add a Key Action and start measuring what matters</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          ...
          <Text style={text}>
            Welcome to day one. The single most important thing you can do right now is add a <strong>Key Action</strong>.
          </Text>

          <Text style={text}>
            Key Actions tell {SITE_NAME} what success looks like on your site — a form submission, a purchase, a call, a booking, a download. Once we know what counts, we can show you which traffic sources, pages, and journeys actually drive results (instead of just visits).
          </Text>

          <Text style={text}>
            It takes about a minute, and it unlocks every meaningful insight in your dashboard.
          </Text>

          <Section style={buttonWrap}>
            <Button style={button} href="https://actvtrkr.com/goals">
              Add Your First Key Action
            </Button>
          </Section>

          <Text style={text}>Need a hand picking one? Just reply — happy to help.</Text>
...
export const template = {
  component: Email,
  subject: 'Add a Key Action — it unlocks the rest of ACTV TRKR',
  displayName: 'Onboarding · Day 1 — Add a Key Action',
