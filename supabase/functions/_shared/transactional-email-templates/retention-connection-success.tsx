...
const Email = ({ account_name, dashboard_url }: Props) => (
  <Html lang="en"><Head /><Preview>You're live — first data received 🎉</Preview>
    <Body style={{ background: '#0b0f17', fontFamily: 'system-ui, sans-serif', color: '#e6e8ee', margin: 0 }}>
      <Container style={{ maxWidth: 560, margin: '0 auto', padding: 24 }}>
        <Heading style={{ color: '#fff', fontSize: 22 }}>You're live{account_name ? `, ${account_name}` : ''} 🎉</Heading>
        <Text>We just received your first data. Tracking is up and running.</Text>
...
export const template: TemplateEntry = {
  component: Email,
  subject: () => "You're live — first data received",
  displayName: 'Retention · Connection success',
