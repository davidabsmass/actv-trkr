...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Call a special deep-debug endpoint that returns form_id mapping info
    const endpoints = [
      `${siteUrl}/wp-json/actv-trkr/v1/avada-debug-deep`,
      `${siteUrl}/?rest_route=/actv-trkr/v1/avada-debug-deep`,
    ];
